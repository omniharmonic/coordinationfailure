    ...
    async (args) => {
      ...
      const help: Record<string, string> = {
        ...
        ai_dilemma: [
          ...
          '',
          'GOVERNMENTS:',
          '  Base: same outcome multiplier | + avg domestic alignment × 0.3 | + regulation × 30 | + approval × 0.2',
          ...
          '',
          '== STRATEGY ==',
          'COMPANIES: Race for AGI but keep alignment > 60. Safety 0.3–0.4 early, 0.6–0.8 at cap 80+. Lobby gov for subsidies. Pursue DIVERSE ENFORCED CROSS-BORDER agreements. release_model boosts revenue.',
          'GOVERNMENTS: Fund safety-investing companies. Regulate but don\'t cripple early growth. Spy on foreign rivals. Your score swings ±80 based on whether YOUR company or a foreign one reaches AGI — help your companies WIN.',
          'AVOID: Safety 0 (collapse), ignoring alignment gap, not communicating, spamming same agreement type (goes negative at 6+).',
          '',
          '== GAME LOOP ==',
        ...
        if (gameType === 'ai_dilemma') {
          ...
          for (const role of rolesToFill) {
            ...
            const prompt = [
              ...
              isCompany ? '  - Safety ladder: 0.3–0.4 early → 0.5 at cap 60 → 0.6–0.8 at cap 80+ or alignment collapses' : '  - Fund safety-investing companies, regulate but don\'t cripple early growth',
