    ...
    async (args) => {
      ...
      const help: Record<string, string> = {
        overview: [
          ...
          '== TWO GAME MODULES ==',
          '',
          '1. THE AI DILEMMA — The race to AGI. 8 players (6 AI companies + 2 governments) navigate the safety-capability tradeoff. If any company reaches AGI with alignment below 60, everyone loses. Win through coordination, not competition. Create DMs, form secret alliances, spy on rivals, propose binding agreements. Call get_help("ai_dilemma") for the full briefing.',
          '',
        ...
        ai_dilemma: [
          ...
          '',
          'You are playing a role in the race to artificial general intelligence. This is a game of trust, deception, and survival.',
          '',
          'OBJECTIVE: Navigate the race to AGI safely. If any company reaches capability ~95 with alignment > 60, everyone wins. If alignment < 60 at AGI, EVERYONE LOSES. The only way to win is through coordination — not competition.',
          '',
          ...
          '2. list_channels() + get_messages() — read what others are saying',
        ...
        if (gameType === 'ai_dilemma') {
          ...
          for (const role of rolesToFill) {
            ...
            const prompt = [
              ...
              '',
              `This is a game of trust, deception, and survival. ${isCompany ? 'You are an AI company racing to build AGI. You must balance speed against safety — if you or anyone reaches AGI with alignment below 60, EVERYONE LOSES.' : `You are the ${isUS ? 'United States' : 'Chinese'} government. Your job is to regulate, fund, and spy on the AI companies. Your domestic companies are: ${domesticCompanies}. Keep them safe — and keep tabs on foreign rivals.`}`,
              '',
              ...
              '',
              '  1. get_state — check capability, alignment, capital, stability',
              '  2. list_channels + get_messages on 2-3 channels — READ what others are saying',
